<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="Btl_Web.Pages.Header" %>
...
<script>
    ...
    function handleSearch() {
        ...
        if (query) {
            window.location.href = `SearchProduct.aspx?q=${encodeURIComponent(query)}`;
        }
    }
</script>
